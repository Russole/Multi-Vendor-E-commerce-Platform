...
const Payments = () => {
    ...
    return (
        <div className='px-2 md:px-7 py-5'>
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-7 mb-5'>
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-1 gap-2 pb-4'>
                <div className='bg-[#6a5fdf] text-[#d0d2d6] rounded-md p-5'>
                    <h2 className='text-lg'>Withdrawal</h2>
                    <div className='pt-5 mb-5'>
                        <form onSubmit={sendRequest} className='w-[400px] max-w-full'>
                            <div className='flex gap-3 flex-wrap'>

                                <input onChange={(e) => setAmount(e.target.value)} value={amount} min='0' type="number" className='flex-grow px-3 py-2 focus:border-indigo-200 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]' name='amount' />
                                <button disabled={loader} className='bg-red-500 hover:shadow-red-500/40 hover:shadow-md text-white rounded-md px-7 py-2'>{loader ? 'loading..' : 'Withdraw'}</button>
